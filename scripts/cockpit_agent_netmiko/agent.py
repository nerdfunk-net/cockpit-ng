...
class CockpitAgent:
    ...
    def _register_agent(self):
        ...
        try:
            ...
            status_data = {
                ...
                "capabilities": "echo,get_running_config,get_startup_config,execute_commands",
                "started_at": now,
                "commands_executed": 0,
            }
    ...
    def _verify_message_auth(self, command_data: dict) -> bool:
        ...
        The backend signs: HMAC-SHA256(canonical_json + ":" + timestamp, shared_secret)
        where canonical_json is json.dumps of the message with the 'auth' key removed,
        sorted keys.  The timestamp must be within a 5-minute window.
        """
        ...
        # Build canonical payload (message without the auth field)
    ...
    async def _handle_message(self, message):
        ...
        try:
            ...
            # Verify HMAC authentication before executing anything
