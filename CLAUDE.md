...
**Frontend:** Next.js 16.2.6 (App Router), React 19, TypeScript 5, Tailwind CSS 4, Shadcn UI, TanStack Query v5, Zustand, Lucide Icons
...
ruff format .          # format (Black-compatible, 88 chars)
