...
class JobTemplateRepository(BaseRepository[JobTemplate]):
    ...
    def get_by_name(self, name: str, user_id: Optional[int] = None) -> Optional[JobTemplate]:
    ...
    def get_user_templates(self, user_id: int, job_type: Optional[str] = None) -> List[JobTemplate]:
    ...
    def get_by_type(self, job_type: str, user_id: Optional[int] = None) -> List[JobTemplate]:
