...
def create_job_run(
    ...
    logger.info(f"Created job run: {job_name} (ID: {job_run_data.get('id')}, triggered_by: {triggered_by})")
...
def mark_completed(run_id: int, result: Optional[Dict] = None) -> Optional[Dict[str, Any]]:
