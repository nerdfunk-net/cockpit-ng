...
class AuditLog(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id", ondelete="SET NULL"))  # Optional FK
    event_type = Column(String(100), nullable=False, index=True)  # authentication, onboarding, device_management, etc.
