...
class Credential(Base):
    ...
    type = Column(String(50), nullable=False, default="generic")  # ssh, tacacs, generic, token, ssh_key
    ...
    ssh_passphrase_encrypted = Column(LargeBinary, nullable=True)  # Encrypted passphrase
