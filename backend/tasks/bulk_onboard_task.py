    ...
    for idx, device in enumerate(devices):
        ...
        try:
            ...
            merged_config = {
                ...
                "interface_status_id": device.get("interface_status_id") or default_config.get("interface_status_id", ""),
                "ip_address_status_id": device.get("ip_address_status_id") or default_config.get("ip_address_status_id", ""),
            ...
            missing_fields = []
            for field in ["location_id", "namespace_id", "role_id", "status_id", 
                          "interface_status_id", "ip_address_status_id", "prefix_status_id", 
                          "secret_groups_id"]:
            ...
            failed_count += 1
            error_msg = str(e)
            logger.error(f"Error processing device {ip_address}: {error_msg}", exc_info=True)
            device_results.append({
                "ip_address": ip_address,
                "status": "error",
                "message": error_msg,
