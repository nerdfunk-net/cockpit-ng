...
def import_devices_from_csv_task(
    ...
    try:
        ...
        logger.info("Import Options: %s", import_options)
        ...
        logger.info("Total devices to import: %s", total_devices)
        ...
        logger.info("-" * 80)
        logger.info("STEP 4: IMPORTING %s DEVICES", total_devices)
        logger.info("Skip duplicates: %s", skip_duplicates)
        logger.info("Create interfaces: %s", create_interfaces)
        logger.info("-" * 80)
