...
def _execute_job_type(
    ...
    job_executors = {
        ...
        "ip_addresses": _execute_ip_addresses,
    }
...
def _execute_ip_addresses(
    ...
    Lists or removes Nautobot IP addresses that match the configured filter.
    All settings are read from the job template.
    """
    ...
    try:
        ...
        logger.error("ip_addresses job failed: %s", e, exc_info=True)
