...
from services.compliance_check_service import ComplianceCheckService
...
async def check_compliance(
    ...
    """
    try:
        logger.info(f"Starting compliance check for {len(check_request.devices)} devices")
        ...
        for device in check_request.devices:
            ...
            if check_request.check_snmp_credentials:
                ...
                for snmp in snmp_mappings:
                    ...
                    result['details']['mapping_name'] = snmp.get('name', snmp['device_type'])
