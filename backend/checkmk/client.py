...
class CheckMKClient:
    ...
    def get_all_monitored_hosts(self, columns: List[str] = None, query: str = None) -> Dict:
        """
    ...
    def get_monitored_host(self, hostname: str, columns: List[str] = None) -> Dict:
        ...
        response = self._make_request(
            'GET',
            f'objects/host/{hostname}',
            params=params
        )
        return self._handle_response(response)
    
    def get_host_services(self, hostname: str, columns: List[str] = None, query: str = None) -> Dict:
        """
    ...
    def show_service(self, hostname: str, service_description: str, columns: List[str] = None) -> Dict:
        """
    ...
    def get_service_discovery(self, hostname: str) -> Dict:
        ...
        response = self._make_request(
            'GET',
            f'objects/service_discovery/{hostname}'
        )
        return self._handle_response(response)
    ...
    def start_service_discovery(self, hostname: str, mode: str = "new") -> Dict:
        ...
        response = self._make_request(
            'POST',
            f'objects/service_discovery_run/{hostname}',
            json_data=json_data
        )
        return self._handle_response(response)
    ...
    def get_activation_status(self, activation_id: str) -> Dict:
        ...
        response = self._make_request(
            'GET',
            f'objects/activation_run/{activation_id}'
        )
        return self._handle_response(response)
    ...
    def get_hosts_in_folder(self, folder_path: str) -> Dict:
        ...
        response = self._make_request(
            'GET',
            f'objects/folder_config/{folder_path}/collections/hosts'
        )
        return self._handle_response(response)
    ...
    def get_host_group(self, group_name: str) -> Dict:
        ...
        response = self._make_request(
            'GET',
            f'objects/host_group_config/{group_name}'
        )
        return self._handle_response(response)
