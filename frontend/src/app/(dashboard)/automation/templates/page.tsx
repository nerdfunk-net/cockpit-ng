...
import { useTemplatesQuery } from '@/components/features/network/automation/templates/hooks/use-templates-queries'
import { useTemplatesMutations } from '@/components/features/network/automation/templates/hooks/use-templates-mutations'

// Feature components
import { TemplateList } from '@/components/features/network/automation/templates/components/template-list'
import { TemplateForm } from '@/components/features/network/automation/templates/components/template-form'
import { TemplateViewDialog } from '@/components/features/network/automation/templates/dialogs/template-view-dialog'
import { HelpAndExamplesContent } from '@/components/features/network/automation/templates/components/help-and-examples'

import type { Template } from '@/components/features/network/automation/templates/types/templates'
