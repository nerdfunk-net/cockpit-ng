    ...
    <div key="unique-id-fhc-1" className="space-y-6">
      ...
      <Card key="unique-id-fhc-7">
        ...
        <CardContent key="unique-id-fhc-10">
          <div key="unique-id-fhc-11" className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div key="unique-id-fhc-33" className="space-y-2" ref={gitSearchRef}>
            ...
            {selectedGitFile && (
              <div key="unique-id-fhc-42" className="text-sm text-gray-600 bg-blue-50 p-2 rounded">
      ...
      <Card key="unique-id-fhc-43">
        <CardContent key="unique-id-fhc-44" className="pt-6">
          <div key="unique-id-fhc-45" className="flex items-center justify-between">
            ...
            >
              {loading ? (
                ...
                <GitCompareIcon key="unique-id-fhc-49" className="h-4 w-4" />
              )}
            ...
            <div key="unique-id-fhc-62" className="flex items-center justify-between">
              <div key="unique-id-fhc-63">
                <CardTitle key="unique-id-fhc-64" className="flex items-center gap-2">
                  ...
                  <span key="unique-id-fhc-66">Git Commit Comparison</span>
                </CardTitle>
            ...
            >
              ...
              {(() => {
                ...
                for (let i = 0; i < maxLines; i++) {
                  ...
                  rows.push(
                    <div key={`unique-id-fhc-row-${i}`} className="grid grid-cols-2 border-b border-gray-200 hover:bg-gray-50">
                      {/* Left side (commit1) */}
