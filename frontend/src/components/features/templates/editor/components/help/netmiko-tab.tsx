  ...
  return (
    <div className="space-y-6">
      ...
      <div className="shadow-lg border-0 p-0 bg-card rounded-lg overflow-hidden">
        <div className="bg-info py-2 px-4 border-b border-info-border">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <Terminal className="h-5 w-5 text-info-foreground" />
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-4">
            <div className="p-4 bg-info rounded-lg border border-info-border">
              <h4 className="font-semibold text-info-foreground mb-2">Nautobot Integration</h4>
            ...
            <div className="p-4 bg-warning rounded-lg border border-warning-border">
              <h4 className="font-semibold text-warning-foreground mb-2">Pre-run Commands</h4>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-success rounded-lg border border-success-border">
              ...
              <div className="bg-card rounded border border-success-border p-2 text-xs text-card-foreground">
                <code className="text-success-foreground">{'{{ my_variable }}'}</code>
                <p className="text-muted-foreground mt-1">User-defined value</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-warning rounded-lg border border-warning-border">
              ...
              <div className="bg-card rounded border border-warning-border p-2 text-xs text-card-foreground">
                <code className="text-warning-foreground">{'{{ yaml_data.key }}'}</code>
                <p className="text-muted-foreground mt-1">Loaded from YAML file</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-info rounded-lg border border-info-border">
              ...
              <div className="bg-card rounded border border-info-border p-2 text-xs text-card-foreground">
                <code className="text-info-foreground">{'{{ nautobot.name }}'}</code>
                <p className="text-muted-foreground mt-1">Device data from Nautobot</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-info rounded-lg border border-info-border">
              ...
              <div className="bg-card rounded border border-info-border p-2 text-xs text-card-foreground">
                <code className="text-info-foreground">
                  {'{{ devices }}, {{ snmp_mapping }}'}
                </code>
                <p className="text-muted-foreground mt-1">Inventory data (Agent mode)</p>
              </div>
            </div>
          </div>

          <div className="mt-4 p-4 bg-info rounded-lg border border-info-border">
            <p className="text-sm text-info-foreground">
      ...
      <div className="shadow-lg border-0 p-0 bg-card rounded-lg overflow-hidden">
        <div className="bg-info py-2 px-4 border-b border-info-border">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <Globe className="h-5 w-5 text-info-foreground" />
        ...
        <div className="p-6 space-y-6">
          <p className="text-muted-foreground text-sm">
            ...
            <code className="bg-muted px-1 rounded">nautobot</code> namespace when
            you select a test device for rendering.
          </p>

          <div className="space-y-4">
            <h4 className="font-semibold text-foreground">Available Device Fields</h4>
            <div className="grid md:grid-cols-2 gap-3 text-sm">
              <div className="space-y-2">
                <div className="p-2 bg-info rounded border border-info-border">
...
{% endif %}`}
      ...
      <div className="shadow-lg border-0 p-0 bg-card rounded-lg overflow-hidden">
        <div className="bg-warning py-2 px-4 border-b border-warning-border">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <Terminal className="h-5 w-5 text-warning-foreground" />
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="p-4 bg-warning rounded-lg border border-warning-border">
            <h4 className="font-semibold text-warning-foreground mb-2">How it works:</h4>
            <ol className="list-decimal list-inside text-sm text-warning-foreground space-y-1">
              <li>
                Enter a command (e.g.,{' '}
              ...
              <li>
                ...
                <code className="bg-warning-border/40 px-1 rounded">pre_run.parsed</code>
              </li>
              <li>
                Raw output is available as{' '}
                <code className="bg-warning-border/40 px-1 rounded">pre_run.raw</code>
              </li>
            </ol>
          </div>

          <div className="space-y-4">
            <h4 className="font-semibold text-foreground">Pre-run Variables</h4>
            <div className="grid md:grid-cols-2 gap-3 text-sm">
              <div className="p-3 bg-muted rounded-lg border">
                <code className="text-primary">{'{{ pre_run.parsed }}'}</code>
                <p className="text-xs text-muted-foreground mt-1">
                  List of parsed results (TextFSM output)
                </p>
              </div>
              <div className="p-3 bg-muted rounded-lg border">
                <code className="text-primary">{'{{ pre_run.raw }}'}</code>
                <p className="text-xs text-muted-foreground mt-1">
...
{% endfor %}`}
      ...
      <div className="shadow-lg border-0 p-0 bg-card rounded-lg overflow-hidden">
        <div className="bg-success py-2 px-4 border-b border-success-border">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <FileCode className="h-5 w-5 text-success-foreground" />
