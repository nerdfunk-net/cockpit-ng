...
export function SnmpHelpDialog({ open, onOpenChange }: SnmpHelpDialogProps) {
  ...
  community: snmp_community`}
              ...
              <ul className="text-xs text-gray-600 list-disc list-inside space-y-1">
                ...
                <li>
                  Simplest configuration but least secure - no encryption or strong
                  authentication
                </li>
          ...
          <div className="space-y-2 border-t pt-4">
            ...
            <ul className="text-sm text-gray-600 list-disc list-inside space-y-1">
              ...
              <li>
                Use strong, unique passwords for auth_password and privacy_password
              </li>
              <li>
                Each SNMP ID should have a unique identifier (e.g., snmp-id-1,
                snmp-id-2)
              </li>
              <li>
                Maintain consistent indentation (2 spaces) throughout the YAML file
              </li>
              <li>
                Test your configuration using the &quot;Check YAML&quot; button before
                saving
              </li>
            </ul>
          </div>
