...
export function CheckMKHelpDialog({ open, onOpenChange }: CheckMKHelpDialogProps) {
          ...
          <div className="space-y-3 border-t pt-4">
            ...
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
              ...
              <li>
                ...
                compared (via the{' '}
                <code className="bg-muted px-1 rounded">compare</code> section)
              </li>
            </ul>
          </div>
    ...
    by_name:
      lab-2: /testfolder`}
              ...
              <p className="text-xs text-muted-foreground mt-1">
                ...
                fields:{' '}
                <code className="bg-muted px-1 rounded">{'{location.name}'}</code>,{' '}
  ...
  status.name: status             # Maps device status to tag_status in CheckMK`}
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Result: Creates{' '}
                <code className="bg-muted px-1 rounded">tag_status</code> attribute
  ...
  - tag_address_family            # Don't compare this attribute`}
          ...
          {/* Backend Features */}
          <div className="space-y-3 border-t pt-4">
            <h3 className="text-sm font-semibold text-foreground">Backend Features</h3>
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
              <li>
          ...
          <div className="space-y-3 border-t pt-4">
            ...
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
              <li>
                Always define a{' '}
                <code className="bg-muted px-1 rounded">default</code> value for site
                and folder configurations
              </li>
              <li>Use role-based folder structures to organize devices logically</li>
              <li>
                Keep the <code className="bg-muted px-1 rounded">compare</code> list
                minimal to avoid unnecessary sync operations
              </li>
              <li>
                Add CheckMK-managed attributes to{' '}
                <code className="bg-muted px-1 rounded">ignore_attributes</code>
              </li>
              <li>
          ...
          <div className="space-y-2 border-t pt-4">
            <h3 className="text-sm font-semibold text-foreground">Complete Example</h3>
            <pre className="bg-muted border border-border rounded-md p-3 text-xs font-mono overflow-x-auto">
              {`monitored_site:
  default: cmk
