...
export function NautobotLocationsWidget() {
    ...
    <Card className="analytics-card border-0 h-full transition-all duration-300 hover:shadow-analytics-lg">
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <div className="p-3 rounded-xl bg-emerald-100 ring-1 ring-white/20">
      ...
      <CardContent className="pt-0">
        ...
        <p className="text-xs text-slate-500 leading-relaxed">Physical locations</p>
      </CardContent>
    </Card>
  )
}
