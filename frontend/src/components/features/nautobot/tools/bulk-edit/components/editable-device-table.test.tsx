...
// Mock Query hooks
vi.mock(
  '@/components/features/nautobot/tools/bulk-edit/hooks/use-nautobot-graphql-queries',
  () => ({
    useNautobotDeviceTypesQuery: () => ({
      data: {
        data: {
          device_types: [{ model: 'DarioRouter', manufacturer: { name: 'DarioCorp' } }],
        },
      },
    }),
  })
...
vi.mock(
  '@/components/features/nautobot/tools/bulk-edit/hooks/use-nautobot-rest-queries',
  () => ({
