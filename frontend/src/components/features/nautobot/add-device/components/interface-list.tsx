                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setValue(`interfaces.${index}.type`, value)
                      }
                      disabled={isLoading}
                    >
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setValue(`interfaces.${index}.status`, value)
                      }
                      disabled={isLoading}
                    >
                      <SelectTrigger className="border-2 border-slate-300 bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 shadow-sm disabled:bg-slate-100 disabled:border-slate-200">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const currentIps =
                          watch(`interfaces.${index}.ip_addresses`) || []
                        // Auto-select namespace if only one is available
                        const defaultNamespace =
                          dropdownData.nautobotDefaults?.namespace ||
                          (dropdownData.namespaces.length === 1
                  ...
                  {(watch(`interfaces.${index}.ip_addresses`) || []).map(
                    (ipAddr, ipIndex) => {
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            {ipAddresses.length > 1 && (
                              <Button
                                type="button"
                                onClick={() => {
                                  const updated = ipAddresses.filter(
                                    (_, i) => i !== ipIndex
                                  )
                          ...
                          <div className="grid grid-cols-4 gap-3">
                            ...
                            <div className="space-y-1">
                              ...
                              <Input
                                {...register(
                                  `interfaces.${index}.ip_addresses.${ipIndex}.address`
                                )}
                            ...
                            <div className="space-y-1">
                              ...
                              <Select
                                value={
                                  watch(
                                    `interfaces.${index}.ip_addresses.${ipIndex}.namespace`
                                  ) ?? ''
                                }
                                onValueChange={value =>
                                  setValue(
                            ...
                            <div className="space-y-1">
                              ...
                              <Select
                                value={
                                  watch(
                                    `interfaces.${index}.ip_addresses.${ipIndex}.ip_role`
                                  ) || 'none'
                                }
                                onValueChange={value =>
                                  setValue(
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center h-8 px-2 rounded-md border border-input bg-background">
                                <Checkbox
                                  checked={
                                    watch(
                                      `interfaces.${index}.ip_addresses.${ipIndex}.is_primary`
                                    ) || false
                                  }
