      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4 text-sm">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">name</code> (or
                device_name, hostname) - Device identifier
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">device_type</code> (or
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground text-xs">
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">role</code> - Device role
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">location</code> (or site)
                - Location/site
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">platform</code> (or os) -
                Platform/OS
              </li>
              <li>
              ...
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">serial</code> - Serial
                number
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">asset_tag</code> - Asset
                tag
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">software_version</code> -
                Software version
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">tags</code> -
          ...
          <div>
            <h4 className="font-semibold mb-2">
              Interface Columns (prefix with interface_)
            </h4>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground text-xs">
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">interface_name</code> -
                Interface name (required)
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">interface_type</code> -
              ...
              <li>
                ...
                - IP with CIDR (e.g., 192.168.1.1/24)
              </li>
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">
              ...
              <li>
                <code className="bg-muted px-1 py-0.5 rounded">set_primary_ipv4</code> -
                Set as primary IP (true/false)
              </li>
              <li>
...
test-1;virtual;12345;testnet;tag-1;eth1;192.168.100.2/24;1000BASE-T (1GE);testdescription-2;true`}
            ...
            <p className="text-muted-foreground text-xs mt-2">
              Note: This example shows a device &quot;test-1&quot; with two interfaces.
              Both rows have the same device_type, serial, etc., but different interface
              details.
            </p>
          </div>
            ...
            <div className="flex gap-2">
              ...
              <div className="text-xs text-info-foreground">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    Device fields must be identical across all rows for the same device
                  </li>
                  <li>If only one interface, set_primary_ipv4 will auto-set to true</li>
                  <li>
                    Configure column mapping if your headers don&apos;t match the
                    standard names
                  </li>
