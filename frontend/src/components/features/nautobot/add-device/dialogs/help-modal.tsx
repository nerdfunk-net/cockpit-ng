        ...
        <div className="space-y-6 py-4">
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              This form allows you to add network devices (routers, switches, firewalls)
              or bare metal servers to Nautobot. The workflow consists of three main
              sections: Device Information, Prefix Configuration, and Network
              Interfaces. You can validate your entries at any time using the
              &quot;Validate&quot; button before final submission.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-error border border-error-border rounded-lg p-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-error-foreground">
                ...
                <li>
                  <strong>Device Role</strong> - Purpose of the device (e.g., Router,
                  Switch, Firewall)
                </li>
                <li>
                ...
                <li>
                  <strong>Device Type</strong> - Hardware model (manufacturer and model
                  number)
                </li>
                <li>
                  <strong>Location</strong> - Physical location in the hierarchy
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-3">
              <div className="bg-muted/50 rounded-lg p-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Operating system or platform (e.g., Cisco IOS, Juniper Junos)
                </p>
              </div>
              <div className="bg-muted/50 rounded-lg p-3">
                <h4 className="font-medium text-sm mb-1">Software Version</h4>
                <p className="text-sm text-muted-foreground">
                  Specific software/firmware version running on the device
                </p>
              </div>
              <div className="bg-muted/50 rounded-lg p-3">
                <h4 className="font-medium text-sm mb-1">Serial Number</h4>
                <p className="text-sm text-muted-foreground">
                  Hardware serial number for asset tracking
                </p>
              </div>
              <div className="bg-muted/50 rounded-lg p-3">
                <h4 className="font-medium text-sm mb-1">Asset Tag</h4>
                <p className="text-sm text-muted-foreground">
                  Organization-specific asset identifier
                </p>
              </div>
              <div className="bg-muted/50 rounded-lg p-3">
                <h4 className="font-medium text-sm mb-1">Description / Comments</h4>
                <p className="text-sm text-muted-foreground">
                  Additional notes or documentation about the device
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Tags allow you to categorize and organize devices with custom labels.
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Custom fields allow you to store additional structured data specific to
            ...
            <div className="bg-info border border-info-border rounded-lg p-4">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-info-foreground mt-2">
                ...
                <li>
                  Different field types: text, number, date, select, boolean, etc.
                </li>
                <li>
                  Some custom fields may be required depending on your configuration
                </li>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground">
              Configure automatic IP address assignment by specifying an IPv4 and/or
              IPv6 prefix. The system will automatically allocate the next available IP
              address from the specified prefix when creating interfaces. This is
              optional and can be left blank if you prefer to assign IPs manually.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Add network interfaces for your device. Each device can have multiple
              interfaces (e.g., Ethernet ports, management interfaces, loopbacks).
            </p>
            <div className="space-y-3">
              <div className="bg-muted/50 rounded-lg p-3">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Name</strong> - Interface identifier (e.g.,
                    GigabitEthernet0/1, eth0)
                  </li>
                  <li>
                    <strong>Type</strong> - Interface type (e.g., 1000BASE-T, SFP+,
                    Virtual)
                  </li>
                  <li>
                    <strong>Status</strong> - Operational status (e.g., Active, Planned,
                    Disabled)
                  </li>
                </ul>
              </div>
              <div className="bg-muted/50 rounded-lg p-3">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  <li>
                    <strong>Description</strong> - Purpose or notes about the interface
                  </li>
                  <li>
                    <strong>MAC Address</strong> - Hardware MAC address
                  </li>
                  <li>
                    <strong>MTU</strong> - Maximum Transmission Unit size
                  </li>
                  <li>
                    <strong>Enabled</strong> - Administrative status (up/down)
                  </li>
                  <li>
                    <strong>Management Only</strong> - Mark if this is a dedicated
            ...
            <div className="bg-warning border border-warning-border rounded-lg p-4">
              ...
              <div className="mt-3 pt-3 border-t border-warning-border">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-warning-foreground">
                  ...
                  <li>
                    <strong>Description</strong> - Additional notes about the IP address
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Click the &quot;Properties&quot; button on any interface to configure
              advanced settings like VLAN assignments, untagged VLANs, and tagged VLANs
              for trunk ports.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Before submitting, you can click the &quot;Validate&quot; button to check
              if all required fields are properly filled out. The validation summary
              will show you:
            </p>
            <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground">
              For bulk device additions, use the &quot;Import from CSV&quot; button. You
              can upload a CSV file with multiple devices and their configurations. The
              import wizard will help you map CSV columns to device fields and validate
