...
export function useOnboardingData() {
  ...
  const [deviceRoles, setDeviceRoles] =
  ...
  const [deviceStatuses, setDeviceStatuses] =
    useState<DropdownOption[]>(EMPTY_DROPDOWN_OPTIONS)
  const [interfaceStatuses, setInterfaceStatuses] =
    useState<DropdownOption[]>(EMPTY_DROPDOWN_OPTIONS)
  const [ipAddressStatuses, setIpAddressStatuses] =
    useState<DropdownOption[]>(EMPTY_DROPDOWN_OPTIONS)
  const [prefixStatuses, setPrefixStatuses] =
    useState<DropdownOption[]>(EMPTY_DROPDOWN_OPTIONS)
      ...
      if (!defaults) {
        ...
        return {
          ...
          ip_address_status_id:
            findDefaultOption(ipAddressStatuses, 'Active')?.id || '',
