  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div
          className={`${result.devices_failed > 0 ? 'status-error' : 'bg-gray-50 border-gray-200'} border rounded-lg p-3 text-center`}
        >
          <div className="flex items-center justify-center gap-2 mb-1">
            <XCircleIcon
              className={`h-4 w-4 ${result.devices_failed > 0 ? 'text-red-600' : 'text-gray-400'}`}
            />
            <p
              className={`text-xs uppercase tracking-wide font-medium ${result.devices_failed > 0 ? 'text-red-600' : 'text-gray-500'}`}
            >
              Failed
            </p>
          </div>
          <p
            className={`text-2xl font-bold ${result.devices_failed > 0 ? 'text-red-700' : 'text-gray-400'}`}
          >
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-green-50 hover:bg-green-50">
                  ...
                  <TableHead className="text-xs font-semibold text-green-800 text-center">
                    SSH
                  </TableHead>
                  <TableHead className="text-xs font-semibold text-green-800 text-center">
                    Running
                  ...
                  <TableHead className="text-xs font-semibold text-green-800 text-right">
                    Size
                  </TableHead>
                </TableRow>
              </TableHeader>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-red-50 hover:bg-red-50">
                  ...
                  <TableHead className="text-xs font-semibold text-red-800 text-center">
                    SSH
                  </TableHead>
                  <TableHead className="text-xs font-semibold text-red-800">
                    Error
