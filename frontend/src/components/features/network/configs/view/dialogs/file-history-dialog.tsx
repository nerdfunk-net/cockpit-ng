...
export function FileHistoryDialog({
  ...
  const handleCompare = useCallback(() => {
    if (selectedCommits.length === 2 && filePath && data) {
      ...
      const olderCommit =
        commit1Index > commit2Index ? selectedCommits[0]! : selectedCommits[1]!
      const newerCommit =
        commit1Index > commit2Index ? selectedCommits[1]! : selectedCommits[0]!
      ...
      <DialogContent className="!max-w-[85vw] !w-[85vw] max-h-[90vh] flex flex-col">
                ...
                {viewCommit ? (
                  ...
                  <table className="w-full min-w-[900px]">
                    <thead className="border-b sticky top-0 bg-background z-10">
                      <tr>
                        <th className="text-left p-3 font-semibold text-sm w-12">
                          Select
                        </th>
                        <th className="text-left p-3 font-semibold text-sm w-32">
                          Commit
                        </th>
                        <th className="text-left p-3 font-semibold text-sm w-24">
                          Type
                        </th>
                        <th className="text-left p-3 font-semibold text-sm max-w-xs">
                          Message
                        </th>
                        <th className="text-left p-3 font-semibold text-sm w-44">
                          Author
                        </th>
                    ...
                    <tbody className="divide-y">
                      {data.commits.map(commit => (
                        ...
                        >
                          ...
                          <td className="p-3">
                            <Badge
                              variant={getChangeTypeVariant(commit.change_type)}
                              className="text-xs"
                            >
                          ...
                          <td className="p-3">
                            <span
                              className="text-sm truncate max-w-md block"
        ...
        <div className="flex items-center justify-between pt-4 border-t flex-shrink-0">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleCompare} disabled={selectedCommits.length !== 2}>
