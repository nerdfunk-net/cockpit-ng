...
import { Loader2, CheckCircle, XCircle, Server, Settings, RotateCcw, Shield } from 'lucide-react'
      ...
      <div className="border-b border-gray-200 pb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600">Configure your CheckMK server connection</p>
          </div>
        </div>
      </div>
