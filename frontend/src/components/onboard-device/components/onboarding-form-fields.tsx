...
export function OnboardingFormFields({
  ...
  return (
    <div className="space-y-4">
      {/* IP Address Check and Device Name Check - Side by side layout */}
      ...
      {/* Device Properties - with styled header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
        ...
        <div className="space-y-1">
          <Label className="text-[11px] font-medium">Timeout (seconds)</Label>
          <Input
            type="number"
